...
class EmployeesList(models.Model):
    ...
    employer = fields.Char(comodel_name='fillers_module.pdf_generator',
                            inverse_name='employer_ids',
                            string='Employeer')
    
    word = fields.Binary(comodel_name='fillers_module.pdf_generator',
                        inverse_name='co_word',
                        string='Word')
    
    pdf = fields.Binary(comodel_name='fillers_module.pdf_generator',
                        inverse_name='co_pdf_file',
                        string='Pdf',
                        readonly=True)
